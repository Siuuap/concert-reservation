...
const AdminRegisterPage = (): React.ReactElement => {
  ...
  return (
    <section className="bg-[#0070A4] h-dvh flex justify-center items-center">
      <form
      ...
      >
        ...
        <button className="bg-[#00A58B] px-[32px] py-[18px] rounded-[12px] text-[#fff] text-base">
          Register
        </button>
      </form>
    </section>
